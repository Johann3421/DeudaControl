            ...
            <div className="max-w-2xl mx-auto space-y-5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-0.5">Actualiza tu nombre, correo o contraseña</p>
                    </div>
                </div>

                <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 p-6 space-y-5">
                    <div className="flex items-center gap-4 pb-4 border-b border-slate-100">
                        <div className="w-14 h-14 rounded-full bg-[#0EA5E9]/15 flex items-center justify-center text-[#0EA5E9] font-bold text-xl">
                            {user.name?.charAt(0).toUpperCase()}
                        </div>
                        <div>
                            <p className="text-sm font-semibold text-slate-900">{user.name}</p>
                            <p className="text-xs text-slate-500 mt-0.5">Rol: <span className="font-medium capitalize">{user.rol}</span></p>
                        </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-slate-100">
                        <p className="text-sm font-medium text-slate-700 mb-1">Cambiar contraseña</p>
                        <p className="text-xs text-slate-500 mb-4">Deja los campos vacíos si no quieres cambiarla.</p>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                />
                                {errors.current_password && <p className="mt-1.5 text-sm text-red-600">{errors.current_password}</p>}
                            </div>
