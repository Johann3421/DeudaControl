...
export default function EntidadesEdit({ entidad }) {
    const { data, setData, put, processing, errors } = useForm({
        razon_social: entidad.razon_social || '',
        ruc: entidad.ruc || '',
        tipo: entidad.tipo || 'publica',
        ...
        <Layout title="Editar Entidad">
            ...
            <div className="max-w-2xl">
                ...
                <div className="bg-white rounded-2xl border border-slate-200 p-6">
                    <h2 className="text-lg font-semibold text-slate-900 mb-6">Editar Entidad</h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            <button type="submit" disabled={processing}
                                ...
                                {processing ? 'Guardando...' : 'Actualizar Entidad'}
                            </button>
