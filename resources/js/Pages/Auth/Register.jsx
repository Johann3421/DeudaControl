        ...
        <>
            ...
            <div className="flex min-h-screen">
                ...
                <div className="hidden lg:flex lg:w-[480px] xl:w-[560px] bg-[#0F172A] relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#8B5CF6]/20 via-transparent to-[#0EA5E9]/10" />
                    <div className="absolute top-1/2 right-0 w-96 h-96 bg-[#8B5CF6]/5 rounded-full blur-3xl translate-x-1/2" />
                    <div className="absolute top-0 left-0 w-80 h-80 bg-[#0EA5E9]/5 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2" />
                    ...
                    <div className="relative flex flex-col justify-between w-full p-10">
                        ...
                        <div className="space-y-6">
                            <h2 className="text-3xl xl:text-4xl font-bold text-white leading-tight">
                                Comienza a controlar<br />
                                <span className="text-[#8B5CF6]">tus prestamos</span>
                            </h2>
                            <p className="text-slate-400 text-base leading-relaxed max-w-sm">
                                Crea tu cuenta y empieza a gestionar deudas, pagos y clientes de forma profesional.
                            </p>
                            ...
                            <div className="space-y-3 pt-4">
                                <div className="flex items-center gap-3 text-slate-300">
                                    ...
                                    <span className="text-sm">Control completo de deudas y pagos</span>
                                </div>
                                <div className="flex items-center gap-3 text-slate-300">
                                    <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <span className="text-sm">Panel administrativo en tiempo real</span>
                                </div>
                                <div className="flex items-center gap-3 text-slate-300">
                                    <div className="w-6 h-6 rounded-full bg-emerald-500/20 flex items-center justify-center shrink-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <span className="text-sm">Historial financiero detallado</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-[#F8FAFC]">
                    <div className="w-full max-w-md">
                        ...
                        <div className="mb-8">
                            ...
                            <p className="text-slate-500 mt-2">Completa los datos para registrarte</p>
                        </div>
